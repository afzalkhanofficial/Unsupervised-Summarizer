...
COMMON_HEAD = """
    ...
    <style>
        ...
        /* Hide the top bar inserted by Google */
        ...
        .goog-te-gadget-simple:hover {
            border-color: #8C4FFF !important;
            color: white !important;
        }

        /* Hide the Google Logo Icon */
        .goog-te-gadget-icon {
            display: none !important;
        }

        /* Fix text color inside the button */
        .goog-te-menu-value {
        ...
        /* Hide the 'Powered by' footer stuff */
        .goog-te-gadget {
            color: transparent !important;
            font-size: 0 !important;
        }
        
        /* Ensures the dropdown generated by Google doesn't break layout */
        .goog-te-menu-frame {
